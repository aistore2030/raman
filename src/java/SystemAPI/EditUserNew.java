...
System.out.println(request.getParameter("c" + j)+"c[value]");
          ...
          /*  query = "update register set c3='" + b[0] + "'  , c4='" + b[1] + "', c5='" + b[2] + "', c6='" + b[3] + "'"
                    ...
                    + " where id=" + id + "  ";*/
           String  query1 = "update register set c3='" + b[0] + "'  , c4='" + b[1] + "', c5='" + b[2] + "', c6='" + b[3] + "'"
                    + ", c7='" + b[4] + "', c8='" + b[5] + "', c9='" + b[6] + "', c10='" + b[7] + "', c11='" + b[8] + "',"
                    + " c12='" + b[9] + "', c13='" + b[10] + "', c14='" + b[11] + "', c15='" + b[12] + "', c16='" + b[13] + "', c"
                    + "17='" + b[14] + "', c18='" + b[15] + "', c19='" + b[16] + "', c20='" + b[17] + "', c21='" + b[18] + "', c22='" + b[19] + "', c"
                    + "23='" + b[20] + "', c24='" + b[21] + "', c25='" + b[22] + "', c26='" + b[23] + "', c27='" + b[24] + "', c28='" + b[25] + "', c29"
              ...
              query  = "update register set c3=N'" + b[0] + "'  , c4=N'" + b[1] + "', c5=N'" + b[2] + "', c6=N'" + b[3] + "'"
                    + ", c7=N'" + b[4] + "', c8=N'" + b[5] + "', c9=N'" + b[6] + "', c10=N'" + b[7] + "', c11=N'" + b[8] + "',"
                    + " c12=N'" + b[9] + "', c13=N'" + b[10] + "', c14=N'" + b[11] + "', c15=N'" + b[12] + "', c16=N'" + b[13] + "', c"
                    + "17=N'" + b[14] + "', c18=N'" + b[15] + "', c19=N'" + b[16] + "', c20=N'" + b[17] + "', c21=N'" + b[18] + "', c22=N'" + b[19] + "', c"
                    + "23=N'" + b[20] + "', c24=N'" + b[21] + "', c25=N'" + b[22] + "', c26=N'" + b[23] + "', c27=N'" + b[24] + "', c28=N'" + b[25] + "', c29"
                    + "=N'" + b[26] + "', c30=N'" + b[27] + "', c31=N'" + b[28] + "', c32=N'" + b[29] + "', c33=N'" + b[30] + "', c34=N'" + b[31] + "', c35=N'" + b[32] + "', c36=N'" + b[33] + "', updated_on=GETDATE() , status='" + st1 + "'"
                    + " where id=" + id + "  ";
